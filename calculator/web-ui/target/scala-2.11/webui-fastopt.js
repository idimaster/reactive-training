...
$c_Lcalculator_Calculator$.prototype.init___ = (function() {
  ...
  this.error$1 = new $c_Lcalculator_Signal().init___F0(new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function() {
    return new $c_Lcalculator_Literal().init___D((NaN))
  })));
  this.data$1 = $as_scm_Map($m_scm_Map$().apply__sc_Seq__sc_GenMap($m_sci_Nil$()));
  return this
});
...
$c_Lcalculator_Calculator$.prototype.eval__Lcalculator_Expr__sci_Map__D = (function(expr, references) {
  _eval: while (true) {
    ...
    if ($is_Lcalculator_Literal(x1)) {
      ...
      var temp$references = $as_sci_Map(references.$$minus__O__sc_Map(x3.name$2));
      expr = temp$expr;
      references = temp$references;
      continue _eval
    } else if ($is_Lcalculator_Plus(x1)) {
      var x4 = $as_Lcalculator_Plus(x1);
      return (this.eval__Lcalculator_Expr__sci_Map__D(x4.a$2, references) + this.eval__Lcalculator_Expr__sci_Map__D(x4.b$2, references))
    } else if ($is_Lcalculator_Minus(x1)) {
      var x5 = $as_Lcalculator_Minus(x1);
      return (this.eval__Lcalculator_Expr__sci_Map__D(x5.a$2, references) - this.eval__Lcalculator_Expr__sci_Map__D(x5.b$2, references))
    } else if ($is_Lcalculator_Times(x1)) {
      var x6 = $as_Lcalculator_Times(x1);
      return (this.eval__Lcalculator_Expr__sci_Map__D(x6.a$2, references) * this.eval__Lcalculator_Expr__sci_Map__D(x6.b$2, references))
    } else if ($is_Lcalculator_Divide(x1)) {
      var x7 = $as_Lcalculator_Divide(x1);
      return (this.eval__Lcalculator_Expr__sci_Map__D(x7.a$2, references) / this.eval__Lcalculator_Expr__sci_Map__D(x7.b$2, references))
    } else {
      return (NaN)
    }
  }
...
$c_Lcalculator_Polynomial$.prototype.init___ = (function() {
  $n_Lcalculator_Polynomial$ = this;
  this.delta$1 = new $c_Lcalculator_Var().init___F0(new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function() {
    return 0.0
  })));
  this.solution$1 = new $c_Lcalculator_Var().init___F0(new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function() {
...
$c_Lcalculator_Polynomial$.prototype.computeSolutions__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal = (function(a, b, c, delta) {
  var this$1 = this.solution$1;
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(a$2, b$2, c$2, delta$1) {
    return (function() {
      return $m_Lcalculator_Polynomial$().calculator$Polynomial$$calculate__D__D__D__D__sci_Set($uD(a$2.apply__O()), $uD(b$2.apply__O()), $uD(c$2.apply__O()), $uD(delta$1.apply__O()))
    })
  })(a, b, c, delta));
  $c_Lcalculator_Signal.prototype.update__F0__V.call(this$1, expr);
  return this.solution$1
});
$c_Lcalculator_Polynomial$.prototype.calculator$Polynomial$$calculate__D__D__D__D__sci_Set = (function(a, b, c, delta) {
  var set = $as_sci_Set($m_s_Predef$().Set$2.apply__sc_Seq__sc_GenTraversable($m_sci_Nil$()));
  if ((delta >= 0)) {
    if ((delta === 0)) {
      set = $as_sci_Set(set.$$plus__O__sc_Set(((-b) / (2 * a))))
    } else {
      set = $as_sci_Set(set.$$plus__O__sc_Set((((-b) + $uD($g["Math"]["sqrt"](delta))) / (2 * a))));
      set = $as_sci_Set(set.$$plus__O__sc_Set((((-b) - $uD($g["Math"]["sqrt"](delta))) / (2 * a))))
    }
  };
  return set
...
$c_Lcalculator_Polynomial$.prototype.computeDelta__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal = (function(a, b, c) {
  ...
  $c_Lcalculator_Signal.prototype.update__F0__V.call(this$2, expr);
  return this.delta$1
});
...
$c_Lcalculator_TweetLength$.prototype.init___ = (function() {
  $n_Lcalculator_TweetLength$ = this;
  this.len$1 = new $c_Lcalculator_Var().init___F0(new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function() {
    return 0
  })));
  this.color$1 = new $c_Lcalculator_Var().init___F0(new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function() {
    return "green"
  })));
  return this
});
...
$c_Lcalculator_TweetLength$.prototype.calculator$TweetLength$$getColor__I__T = (function(len) {
  return ((len >= 15) ? "green" : (((len >= 0) && (len < 15)) ? "orange" : "red"))
});
...
var $is_Lcalculator_Var = (function(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lcalculator_Var)))
});
var $as_Lcalculator_Var = (function(obj) {
  return (($is_Lcalculator_Var(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "calculator.Var"))
});
var $isArrayOf_Lcalculator_Var = (function(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lcalculator_Var)))
});
var $asArrayOf_Lcalculator_Var = (function(obj, depth) {
  return (($isArrayOf_Lcalculator_Var(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lcalculator.Var;", depth))
});
...
/** @constructor */
var $c_scg_MutableMapFactory = (function() {
  $c_scg_MapFactory.call(this)
});
...
/** @constructor */
var $h_scg_MutableMapFactory = (function() {
  /*<skip>*/
});
...
var $d_scm_Map$ = new $ClassTypeData({
  scm_Map$: 0
...
$c_Lcalculator_Calculator$$anonfun$computeValues$1.prototype.apply__T2__T2 = (function(x0$1) {
  if ((x0$1 !== null)) {
    var s = $as_T(x0$1.$$und1$f);
    var v = $as_Lcalculator_Signal(x0$1.$$und2$f);
    var this$1 = $m_Lcalculator_Calculator$().data$1;
    var x1 = this$1.get__O__s_Option(s);
    if ($is_s_Some(x1)) {
      var x2 = $as_s_Some(x1);
      var v$1 = x2.x$2;
      var jsx$1 = v$1
      ...
      if ((x === x1)) {
        ...
        var d = new $c_Lcalculator_Var().init___F0(expr);
        this$1.update__O__O__V(s, d);
        var jsx$1 = d
      } else {
        var jsx$1;
        throw new $c_s_MatchError().init___O(x1)
    ...
    var signal = $as_Lcalculator_Var(jsx$1);
    var expr$1 = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(arg$outer, v$1$1) {
      return (function() {
        return $m_Lcalculator_Calculator$().eval__Lcalculator_Expr__sci_Map__D($as_Lcalculator_Expr(v$1$1.apply__O()), arg$outer.namedExpressions$1$f)
      })
    })(this, v));
    $c_Lcalculator_Signal.prototype.update__F0__V.call(signal, expr$1);
    return new $c_T2().init___O__O(s, signal)
  } else {
    throw new $c_s_MatchError().init___O(x0$1)
  }
});
...
var $d_scm_HashMap$$anon$3 = new $ClassTypeData({
