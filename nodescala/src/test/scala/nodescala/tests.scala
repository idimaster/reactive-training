...
class NodeScalaSuite extends FunSuite {
  ...
  test("any") {
    val d1 = Future.delay(1 second)
    val d2 = Future.delay(3 second)
    val d3 = Future.delay(6 second)

    val f = Future.any(List(d1, d2, d3))
  ...
  test("all") {
    val d1 = Future.delay(1 second)
    val d2 = Future.delay(2 second)
    val d3 = Future.delay(3 second)

    val f = Future.all(List(d1, d2, d3))
